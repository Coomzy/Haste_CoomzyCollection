...
public class EnergyUpdater : MonoBehaviour
{
	...
	{
		switch (FullEnergyStartMod.UnlimitedEnergyType)
		{
			case UnlimitedEnergyType.Off:
			case UnlimitedEnergyType.HubOnly when !FullEnergyStartMod.IsInHub:
				return;
...
public class UnlimitedEnergyTypeSetting : EnumSetting<UnlimitedEnergyType>, IExposedSetting
{
	...
	{
		FullEnergyStartMod.UnlimitedEnergyType = Value;
	}
